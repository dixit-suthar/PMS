...
<body class="custom-bac">
    <div class="container bg-light m-5 p-5 h-75 min-vh-100">
        <h1 class="text-capitalize">Welcome <?php echo $_SESSION['name'] ?></h1>
        <br>
        <div class="row">
            <div class="col-md-7">
                <div class="list-group">
                    ...
                    <a href="faculty.php" class="list-group-item list-group-item-action list-group-item-light fw-bold">View Faculty</a>
